...
_REFERENCE_PROMPT = (
    ...
    "- CRITICAL CONTENT: The generated figure must ONLY visualize the method described in the text above. Do NOT reproduce, copy, or include any text content, labels, or subject matter from the reference image. The reference image is used SOLELY as a style and color reference."
)
